...
export default function UniversityCard({
  ...
  return (
    ...
    >
      ...
      <CardBody>
        <Typography variant="h4" color="blue-gray" className={animationClass}>
          {name}
        </Typography>
        <Typography variant="h5" color="blue-gray" className={animationClass}>
          {degreeType}
        </Typography>
        <Typography variant="h6" color="blue-gray" className={animationClass}>
          {degree}
        </Typography>
        <Typography color="gray" className={`mt-3 w-full ${animationClass}`}>
          {description}
        </Typography>
      </CardBody>
