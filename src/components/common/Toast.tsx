...
const Toast: React.FC<ToastProps> = ({ type, message, onClose }) => {
  ...
  return (
    <div className={`border-l-4 p-4 shadow-md rounded-r-lg ${styles[type]}`}>
      <div className="flex items-start">
        {icons[type]}
        <div className="ml-3">
          <p className="text-sm font-medium">{message}</p>
        </div>
        <button onClick={onClose} className="ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 focus:outline-none">
